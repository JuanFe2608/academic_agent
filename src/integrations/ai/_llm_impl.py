...
def llm_normalize_schedule(text: str, schedule_hint: str | None = None) -> str | None:
    ...
    prompt = (
        ...
        "- Expande abreviaturas de dia: LUN->Lunes, MAR->Martes, MIE->Miercoles, "
        "JUE->Jueves, VIE->Viernes, SAB->Sabado, DOM->Domingo.\n"
        "- Si hay varios dias separados por coma (ej. MAR,VIE 07:00-09:00 Materia), "
        "genera una linea por dia (Martes 07:00-09:00 Materia y Viernes 07:00-09:00 Materia).\n"
        "- Si la hora tiene segundos (ej. 07:00:00), conviertela a HH:MM (07:00).\n"
        ...
        "- Conserva el nombre de la materia exactamente como aparece en el texto; no lo reemplaces ni lo normalices.\n"
...
def llm_extract_schedule_blocks(
    ...
    prompt = (
        ...
        "- Separa varias materias en la misma línea cuando tienen rangos distintos.\n"
        "- Si un día aparece al inicio de una línea, aplícalo a las materias siguientes de esa línea hasta que aparezca otro día.\n"
        "- Si el texto repite la misma hora en otro formato, por ejemplo '2pm a 4pm o en horario militar 14:00 a 16:00', crea un solo bloque.\n"
        "- Ignora encabezados, saludos, nombres de estudiante, códigos, créditos, fechas, sedes, salones y textos como Image/Imagen.\n"
        "- Si el tipo es 'academic', omite actividades que claramente NO son materias del plan de estudios: "
        "gym, gimnasio, natación, fútbol, tenis, yoga, crossfit, trotar, iglesia, misa, deporte, entrenamiento, etc. "
        "Estas son extracurriculares y se registran en otra sección.\n"
        "- Si el tipo es 'work' u otro, aplica el mismo criterio: solo incluye bloques del tipo indicado.\n"
