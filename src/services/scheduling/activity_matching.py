"""Emparejamiento de actividades del dominio scheduling."""
...
from .ai_support import llm_extract_json
...
def normalize_text(value: str) -> str:
    """Normaliza texto para comparaciones simples dentro del dominio scheduling."""
...
__all__ = ["resolve_best_title_key", "suggest_similar_titles"]
