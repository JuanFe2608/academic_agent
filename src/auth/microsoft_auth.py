...
def build_microsoft_oauth_client_from_env(
    *,
    ...
    config = MicrosoftOAuthConfig(
        ...
        tenant_id=_env_value("MICROSOFT_TENANT_ID", "MS_TENANT_ID") or "common",
        client_secret=_env_value("MICROSOFT_CLIENT_SECRET", "MS_CLIENT_SECRET") or None,
        redirect_uri=_env_value("MICROSOFT_REDIRECT_URI", "MS_REDIRECT_URI"),
        scopes=scopes,
        authority_base_url=(
            _env_value("MICROSOFT_AUTHORITY_BASE_URL", "MS_AUTHORITY_BASE_URL")
            or _DEFAULT_AUTHORITY_BASE_URL
        ),
        graph_base_url=(
            _env_value("MICROSOFT_GRAPH_BASE_URL", "MS_GRAPH_BASE_URL")
            or _DEFAULT_GRAPH_BASE_URL
        ),
    )
